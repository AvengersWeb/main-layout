    ...
    <section className="py-12 md:py-20 border-t border-gray-300">
      <div className="container mx-auto px-4">
        ...
        >
          <div>
            <div
              className={`absolute arrow-left bg-white shadow-xl py-5 px-1 z-10 top-[77px]  ${
                currentIndex === 0
                  ? 'opacity-20 cursor-not-allowed'
                  : 'opacity-100 cursor-pointer'
              }`}
            ...
            <div
              className={`absolute arrow-right bg-white shadow-xl py-5 px-1 z-10 top-[77px] right-0 cursor-pointer `}
            >
              <IoMdArrowDropright size={30} />
            </div>
          </div>
              ...
              >
                <div className="flex justify-center items-center">
                  <img
                    src={product.featured_image}
                    alt=""
                    className="object-cover text-center max-w-[200px] max-h-[200px] w-full"
                  />
                </div>
                <div className="flex items-center flex-col gap-y-2 py-4 pr-3 pl-1">
                  <h4 className="text-lg font-medium font-primary group-hover:text-primary duration-300 overflow-hidden text-ellipsis line-clamp-1">
                    {product.title}
                  </h4>
                </div>
              </Link>
